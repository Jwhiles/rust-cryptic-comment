...
const CommentForm = ({ postId }: any) => {
  ...
  return (
    <form className="commentform-container" onSubmit={e => e.preventDefault()}>
      <h2>Write a comment</h2>  
      <div className="commentform-section">
      <label>
        Comment:
        <textarea className="commentform-textarea" value={comment} onChange={e => setComment(e.target.value)} />
      </label>
      </div>
      <div className="commentform-section">
      <label>
